  ...
  try {
    allCompletions = await db
      .select({
        ...
        certificateUrl:       moduleCompletions.certificateUrl,
      })
      ...
      <div className="content-prose">
          ...
          {[
            {
              ...
              value: totalCpdHours % 1 === 0 ? String(totalCpdHours) : totalCpdHours.toFixed(1),
              colour: 'var(--gold)',
            },
            {
              label: 'Modules Completed',
              value: `${uniqueCompletions.length} / ${TOTAL_MODULES}`,
              colour: 'var(--navy)',
            },
            {
        ...
        {filtered.length === 0 ? (
          <div style={{
            ...
            {uniqueCompletions.length === 0 ? (
              ...
              <div style={{ fontSize: '13px', color: 'var(--text-muted)' }}>
                No completions match the selected date range.
              </div>
            )}
          </div>
        ) : (
          <div style={{
            ...
            <div style={{
              display: 'grid',
              gridTemplateColumns: '1fr 140px 80px 90px 110px',
              gap: '0',
              padding: '11px 20px',
              background: 'var(--navy)',
              fontSize: '11px',
              ...
              >
                ...
                <span>
                  <span style={{
                    ...
                    padding: '2px 8px',
                    borderRadius: '4px',
                    background: c.quizScore >= 90 ? '#f0faf4' : 'var(--gold-pale)',
                    color: c.quizScore >= 90 ? '#2A7D4F' : 'var(--navy)',
                    fontWeight: 700,
                    fontSize: '12px',
                  }}>
                    {c.quizScore}%
                ...
                <span style={{ color: 'var(--text-muted)' }}>
                  {parseFloat(c.cpdHours).toFixed(1)} hr
                </span>
                <span>
                  {c.certificateUrl ? (
                    <a
            ...
            <div style={{
              ...
              <span style={{ color: 'var(--gold)' }}>
                {totalCpdHours % 1 === 0 ? totalCpdHours : totalCpdHours.toFixed(1)} hrs
              </span>
              <span></span>
            </div>
          </div>
